  ...
  if (clip.intersects(boundingPoly.boundingRect()))
  {
    ...
    switch (mStyle)
    {
      ...
      case bsCurly:
      {
        ...
        QPainterPath path;
        path.moveTo((centerVec+widthVec+lengthVec).toPointF());
        path.cubicTo((centerVec+widthVec*1.0f-lengthVec*0.8f).toPointF(), (centerVec+0.4f*widthVec+1.0f*lengthVec).toPointF(), centerVec.toPointF());
        path.cubicTo((centerVec-0.4f*widthVec+1.0f*lengthVec).toPointF(), (centerVec-widthVec*1.0f-lengthVec*0.8f).toPointF(), (centerVec-widthVec+lengthVec).toPointF());
        painter->drawPath(path);
        break;
      }
      case bsCalligraphic:
      {
        ...
        path.cubicTo((centerVec+widthVec*1.0f-lengthVec*0.8f).toPointF(), (centerVec+0.4f*widthVec+0.8f*lengthVec).toPointF(), centerVec.toPointF());
        path.cubicTo((centerVec-0.4f*widthVec+0.8f*lengthVec).toPointF(), (centerVec-widthVec*1.0f-lengthVec*0.8f).toPointF(), (centerVec-widthVec+lengthVec).toPointF());
        
        path.cubicTo((centerVec-widthVec*1.0f-lengthVec*0.5f).toPointF(), (centerVec-0.2f*widthVec+1.2f*lengthVec).toPointF(), (centerVec+lengthVec*0.2f).toPointF());
        path.cubicTo((centerVec+0.2f*widthVec+1.2f*lengthVec).toPointF(), (centerVec+widthVec*1.0f-lengthVec*0.5f).toPointF(), (centerVec+widthVec+lengthVec).toPointF());
